...
export default {
  methods: {
    async postPublication() {
      const token =
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2MTY2ZjUxMDUyYmY4MjAwMWU5ZWNjMmUiLCJpYXQiOjE2MzQxNDQ5MTksImV4cCI6MTYzNDIzMTMxOX0.Drx6RUqMWuNk7FZkE1UDrHIYeT_z9OLBFjPT1aRXK5Q";
